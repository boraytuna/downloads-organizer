...
desktop_dir = '/Users/boraytuna/Desktop'  

# Ensure target directories exist in Downloads
subdirectories = ["/Images", "/Music", "/Videos", "/Documents", "/Code", "/Other", "/Animations"]
...
while True:
    ...
    for item in os.listdir(downloads_dir):
        ...
        if os.path.isfile(item_path):
            ...
            elif extension in animation_extensions:
                target = os.path.join(desktop_dir, "Animations") 
            else:
